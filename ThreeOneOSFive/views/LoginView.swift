            ...
            ScrollView {
                VStack(spacing: 30) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Enter your license key. It is validated securely and bound to this installation.")
                            .font(.system(size: 16))
                    ...
                    Text("The key is stored in the device-only Keychain. The server authorizes each protected operation; no background heartbeat is used.")
                        .font(.system(size: 12))
