...
enum ModType: String, CaseIterable, Identifiable, Hashable {
    ...
    var subtitle: String {
        ...
        case .cacheHsPescoco: return "HS NO PESCOÇO DO INIMIGO"
        case .cacheHsAlto: return "HS ACIMA DA CABEÇA DO INIMIGO"
        case .cacheHsPeito: return "HS NO PEITO DO INIMIGO"
        case .cacheBalaMagica: return "ACERTA TIROS A DISTÂNCIA DO INIMIGO MESMO QUANDO A MIRA NÃO GRUDA"
